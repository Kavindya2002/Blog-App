    ...
    <Navbar/>
      ...
      <div className='max-w-3xl mx-auto'>
        ...
        <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
          ...
          <textarea  onChange={(e)=> setName(e.target.value)}placeholder='Comment' className='w-full p-2 border border-gray-300 rounded outline-none h-48' required></textarea>
