            ...
            <div className='w-full py-6 text-center'>
                ...
                <form onSubmit={handleSubmit} className='mt-6 w-full sm:max-w-md text-gray-600'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input onChange={e=> setEmail(e.target.value)} value={email}  type="password" required placeholder='your email id' className='border-b-2 border-gray-300 p-2 outline-none mb-6' />
                    </div>
